...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama Mesa e Banho'),(4,'Eletrônicos'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumaria'),(8,'Vestuário'),(9,'teste');
...
INSERT INTO `cliente` VALUES (1,'123456789','maria@net.com','Maria Silva',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','42432433','apt 303','Rua Flores','300',1,1),(2,'Centro','42432433','Sala 800','Avenida Matos','105',2,1);
...
INSERT INTO `pagamento_boleto` VALUES (NULL,'2017-10-19 23:00:00',2);
...
CREATE TABLE `pedido` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `instance` datetime DEFAULT NULL,
  `cliente_id` int(11) DEFAULT NULL,
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV Color',1200),(8,'Roçadeira',800),(9,'Abajour',100),(10,'Pendente',180),(11,'Shampoo',90);
...
INSERT INTO `telefone` VALUES (1,'1111111111'),(1,'22222222222');
...
-- Dump completed on 2019-09-10 19:25:09
